...
namespace CellularAutomataScreensaver
{
    ...
    public partial class App : Application
    {
        ...
        {
            // Display in regular windowed mode if no parameters were passed.
            if (!e.Args.Any())
            {
                MainWindow win = new MainWindow(WindowMode.Window);
                win.Show();
            }
            else
            {
                ...
                {
                    winSaver = new MainWindow(WindowMode.Preview);
                ...
                {
                    MainWindow win = new MainWindow(WindowMode.Screensaver);
